...
//---------
unsigned int address = 0;  //0 -> 65,535
long storeValue = 0;       //-2,147,483,648 to 2,147,483,647
long readStoreValue = 0;
...
void setup() {
  ...
  readStoreValue = EEPROMReadlong(address);
  Serial.print("Read Stored Data: ");
  Serial.println(readStoreValue);
  delay(5000);
}
//-2,147,483,648 to 2,147,483,647
void loop() {
  // put your main code here, to run repeatedly:
  lastEncoderPos = 100200300*encoderPos;
  Serial.println(lastEncoderPos);

  if (digitalRead(enSW) == 0) {
    while (digitalRead(enSW) == 0);
    EEPROMWritelong(address,lastEncoderPos);
